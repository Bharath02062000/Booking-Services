...
import './Term.css'
import termimg from '../../assets/termimg.png'
    ...
    <div className='term'>
        <div className='term1'>
            ...
            <ol>
                ...
                <ul>
                    <div className='t1'>1.Contractual Relationship:</div>
                    <div>IDOTINFINITY PRIVATE LIMITED, incorporated under the Companies Act, 2013, having its registered office at 13-6-798/A/189/D/1, Bapu Ghat, Langer House Hyderabad Hyderabad TG 500008 IN, operating under the trademarked name “Idot Infinity”, provides holistic car services including maintenance, repair, etc. The use and access of our website ……….. (“Website”), and our mobile applications “Idot Infinity - Car Services, Battery & Tyre” (“Applications”), or any products or services in connection with the Application or Website (“Services”) shall be governed by these terms and conditions (“Terms”). The Website and Applications are together called the “Platform”.</div><br/>
                    <div> 
                    The Company reserves the right, in its sole discretion, to change, modify or amend the Terms for complying with the legal or regulatory framework and for other legitimate business purposes, at any time, and the Company will post the amended Terms at the domain of www.Idot Infinity.in/terms. It is your responsibility to review the Terms for any changes and you are encouraged to check the Terms frequently. The Company shall not be under an obligation to notify Users of any changes to the Terms and Conditions. If you continue to use the Platform, Content (as defined below) and/or Services after the updated Terms and Conditions have been published, it shall be deemed that you have read and understood and accept the updated Terms and Conditions. Any reference to Terms and Conditions, made herein shall refer to the latest version of the Terms and Conditions.
                ...
                <ul>
                    <div className='t1'>2.Idotinfinity</div>
                    <ul>
                        <li>
                        <div>Contractual Relationship:</div><br/>
                        <div>Content” will include (but is not limited to) reviews, images, photos, audio, video, location data, nearby places, and all other forms of information or data. "Your Content" or "User Content" means Content that you upload, share or transmit, through or in connection with the Services, such as likes, ratings, reviews, images, photos, messages, profile information, and any other materials that you publicly display or displayed in your account profile. "Idot Infinity Content" means Content that the Company creates and makes available in connection with the Services including, but not limited to, visual interfaces, interactive features, graphics, design, compilation, computer code, products, software, aggregate ratings, reports and other usage-related data in connection with activities associated with your account and all other elements and components of the Services excluding Your Content.</div><br/>
                        <div> <br/>
                        ...
                        <div>“Membership Plan(s)” means subscription or other kinds of membership offers provided by the Company to Users from time to time through online or offline media. The terms, conditions and prices of such plans shall be communicated through the applicable media at the time of issuance of such offers.     </div><br/>
                        <div> 
                    ...
                    “User” or “You” shall mean any individual who owns a car (primarily out of the manufacture warranty period) in urban centers especially metros, who is desirous of availing Services on the Platform as and who are registered on the Platform for this purpose
                      ...
                      The Company also provides towing service to get your vehicle out of the situation and back on road on a chargeable basis. 
                        ...
                        <div >
                      You acknowledge that the Company does not provide any repair and maintenance services for its customers and that all such above stated services You acknowledge that the Company does not provide any repair and maintenance services for its customers and that all such above stated services  
